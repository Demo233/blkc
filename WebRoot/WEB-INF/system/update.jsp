...
function save()
{
	idFrmMain.action = "${pageContext.request.contextPath}/user/user_update?id=" + ${user.id };
	idFrmMain.submit();
}
...
<table border="0" width="100%" id="table1" cellspacing="0"  cellpadding="2"  bgcolor="gray">
    ...
    <td class="headerbar63" width="85%" colspan="1">
      ...
      <input type="button" onClick="javascript:back()" value=" 返 回 ">
    </td>
  </tr>
</table>
...
<table border="0" width="100%" id="table1" cellspacing="1"  cellpadding="2"  bgcolor="gray">
    ...
    <td class="textbar01" width="85%" colspan="1">
    	<input name="userLogin" value="${user.userLogin }" size="20" readonly="readonly">
    </td>
  </tr>          
  <tr>
  	<td class="textbar81" width="15%" colspan="1">用户姓名</td>
    <td class="textbar01" width="85%" colspan="1"><input name="userName" value="${user.userName }" size="20"></td>
  </tr>          
	<tr>
  	<td class="textbar81" width="15%" colspan="1">用户密码</td>
    <td class="textbar01" width="85%" colspan="1"><input type="text" name="userPwd" value="${user.userPwd }" readonly="readonly" size="21"></td>
  </tr>      
	<tr>
  	<td class="textbar81" width="15%" colspan="1">用户简介</td>
    <td class="textbar01" width="85%" colspan="1"><textarea name="note"  style="width:352px">${user.note }</textarea>
     </td>
  </tr>  
	         
	 
</table>
<span style="list-style-type: none;color:red;"><s:actionerror/></span>
